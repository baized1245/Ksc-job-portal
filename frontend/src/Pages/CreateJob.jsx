        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="create-job-flex">
            ...
            <div className="lg:w-1/2 w-full">
              ...
              >
                ...
                <option value="work remotely">Work Wemotely</option>
              </select>
            </div>
          </div>
          ...
          <div className="create-job-flex">
            <div className="lg:w-1/2 w-full">
              ...
              <input
                type="text"
                placeholder="Past Your Company Logo"
            ...
            <div className="lg:w-1/2 w-full">
              ...
              <select
                ...
                className="create-job-input"
              >
                <option value="">Chose Your Job Type</option>
                <option value="Full-time">Full-time</option>
                <option value="Part-time">Part-time</option>
                <option value="Temporary">Work Wemotely</option>
              </select>
            </div>
          </div>
          ...
          <div className="w-full">
            ...
            <textarea
              ...
              rows={6}
              defaultValue={
                'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tempore, reiciendis ut?'
              }
